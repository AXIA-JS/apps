...
function useWeightFee(weight, apiOverride) {
  ...
  return (0, _react.useMemo)(() => {
    ...
    return (0, _util.isUndefined)(apiOverride) || apiOverride ? (((_consts$transactionPa = (apiOverride || api).consts.transactionPayment) === null || _consts$transactionPa === void 0 ? void 0 : _consts$transactionPa.weightToFee) || []).reduce((acc, _ref) => {
      let {
        coeffFrac,
        coeffInteger,
        degree,
