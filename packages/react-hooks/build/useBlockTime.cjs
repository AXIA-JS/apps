...
function useBlockTime() {
  let blocks = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _util.BN_ONE;
  let apiOverride = arguments.length > 1 ? arguments[1] : undefined;
  const {
    t
  ...
  return (0, _react.useMemo)(() => {
    ...
    ? a.consts.timestamp.minimumPeriod.mul(_util.BN_TWO) : a.query.allychainSystem // default guess for a allychain
