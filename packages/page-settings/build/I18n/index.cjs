...
function progressDisplay() {
  let [done, total, _] = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [0, 0, 0];
  return {
    done,
...
function Translate(_ref) {
  ...
  (0, _react.useEffect)(() => {
    setLng(keys.some(_ref2 => {
      let {
        value
      } = _ref2;
      return value === _uiSettings.settings.i18nLang;
    }) ? _uiSettings.settings.i18nLang : 'zh');
  }, [keys]);
