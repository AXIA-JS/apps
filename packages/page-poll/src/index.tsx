...
import type { Approvals, Balance, BlockNumber } from '@axia-js/types/interfaces';
    ...
    <main className={className}>
      ...
      <div className='pollContainer'>
        ...
        <article className='keepAlive'>
          <p><Trans key='poll1'>The AXIA DOT denomination vote: Seventy-two hours after the DOT token becomes transferable, the most popular option from this poll will decide the denomination used for the DOT token.</Trans></p>
          ...
          <p><Trans key='poll3'>Please see the <a href='https://medium.com/axia-network/the-first-axia-vote-1fc1b8bd357b' rel='noreferrer' target='_blank'>Medium article </a> for more information</Trans></p>
          {canVote && (
        ...
        <div className='pollActions'>
          <ul>
            ...
            <li>{t('This vote does not affect any economics of the AXIA platform. Staking rewards, inflation, effective market capitalisation and the underlying balances of every account remain completely unchanged. It is "merely" about what units we use to denominate the balances into "AXC" for the purpose of display.')}</li>
          </ul>
        </div>
      </div>
    </main>
