...
function IdentitySubModal({
  ...
  const _setAddress = (0, _react.useCallback)((index, address) => setInfos(infos => (infos || []).map(([a, n], i) => [index === i ? address : a, n])), []);

  const _setName = (0, _react.useCallback)((index, name) => setInfos(infos => (infos || []).map(([a, n], i) => [a, index === i ? name : n])), []);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactComponents.Modal, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.Modal.Content, {
      children: !infos ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.Spinner, {
        ...
        children: [!infos.length ? /*#__PURE__*/(0, _jsxRuntime.jsx)("article", {
        ...
        }) : infos.map(([address, name], index) => /*#__PURE__*/(0, _jsxRuntime.jsx)(IdentitySubMemo, {
          address: address,
          index: index,
          name: name,
          ...
          setName: _setName,
          t: t
        }, index)), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactComponents.Button.Group, {
