...
function checkValue(hasValue, value, minLength, includes, excludes, starting) {
  let notStarting = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : WHITESPACE;
  let notEnding = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : WHITESPACE;
