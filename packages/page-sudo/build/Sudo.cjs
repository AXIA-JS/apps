...
function Sudo(_ref) {
  ...
  const _onChangeExtrinsic = (0, _react.useCallback)(function () {
    let method = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    return setMethod(() => method);
  }, []);

  const _onChangeWeight = (0, _react.useCallback)(function () {
    let weight = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _util.BN_ZERO;
