...
function Proposals({
  ...
  const proposals = (0, _reactHooks.useCall)(api.derive.democracy.proposals);
  const headerRef = (0, _react.useRef)([[t('proposals'), 'start', 2], [t('proposer'), 'address'], [t('locked'), 'media--1200'], [undefined, undefined, 2], [undefined, 'media--1000']]);
