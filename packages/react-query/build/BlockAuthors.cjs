...
exports.ValidatorsContext = exports.BlockAuthors = exports.BlockAuthorsContext = void 0;
...
function BlockAuthorsBase({
  ...
  (0, _react.useEffect)(() => {
    if (queryPoints) {
      const entries = [...queryPoints.individual.entries()].map(([accountId, points]) => [accountId.toString(), (0, _util.formatNumber)(points)]);
