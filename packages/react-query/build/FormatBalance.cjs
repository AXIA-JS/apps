...
function getFormat(registry) {
  let formatIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
function createElement(prefix, postfix, unit) {
  let label = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
  let isShort = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
...
function applyFormat(value, _ref) {
  let [decimals, token] = _ref;
  let withCurrency = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  let withSi = arguments.length > 3 ? arguments[3] : undefined;

  let _isShort = arguments.length > 4 ? arguments[4] : undefined;

  let labelPost = arguments.length > 5 ? arguments[5] : undefined;
