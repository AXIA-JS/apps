...
function BlockAuthorsBase({
  ...
  useEffect(() => {
    ...
    api.isReady.then(() => {
      ...
      let lastBlockNumber = '';
      const isAuthorIds = isFunction((_api$query$authorMapp = api.query.authorMapping) === null || _api$query$authorMapp === void 0 ? void 0 : _api$query$authorMapp.authorIds); // TODO-MOONBEAM reevaluate in a month: 07/16/21
