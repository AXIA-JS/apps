...
function useAbi() {
  let initialValue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [null, null];
  let codeHash = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  let isRequired = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
