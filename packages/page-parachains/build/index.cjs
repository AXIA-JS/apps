...
function ParachainsApp({
  ...
  const paraIds = (0, _reactHooks.useCall)(api.query.paras.parachains);
...
var _default = /*#__PURE__*/_react.default.memo((0, _styledComponents.default)(ParachainsApp).withConfig({
  displayName: "src",
