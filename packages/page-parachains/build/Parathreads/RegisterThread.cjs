...
function RegisterThread({
  ...
  const _setOwner = (0, _react.useCallback)(({
    accountId,
    paraId
  }) => {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactComponents.Modal.Content, {
      children: [api.tx.registrar.reserve ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_InputOwner.default, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.Modal.Columns, {
          ...
          hint: t('The id of this parachain as known on the network'),
        ...
        hint: t('The WASM validation function for this parachain.'),
        ...
        hint: t('The genesis state for this parachain.'),
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.InputFile, {
        ...
        hint: t('The reservation fee for this parachain, including base fee and per-byte fees'),
