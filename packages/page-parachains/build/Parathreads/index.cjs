...
function Parathreads({
  ...
  const leaseMap = (0, _reactHooks.useCall)(ids && api.query.slots.leases.multi, [ids], {
    transform: (0, _react.useCallback)(([[paraIds], leases]) => extractParaMap(hasLinksMap, paraIds, leases), [hasLinksMap]),
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Actions.default, {
      ...
      children: leasePeriod && (leaseMap === null || leaseMap === void 0 ? void 0 : leaseMap.map(([id, leases]) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_Parathread.default, {
        id: id,
