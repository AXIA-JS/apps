...
function extractState(payout) {
  ...
  const eraStr = (0, _util.createErasString)(payout.eras.map(({
    era
  }) => era));
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("tr", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("td", {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.Expander, {
        ...
        children: Object.entries(nominators).map(([stashId, balance]) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.AddressMini, {
          balance: balance,
          value: stashId,
          withBalance: true
        }, stashId))
