...
function KickNominees(_ref) {
  ...
  const nominators = (0, _react.useMemo)(() => {
    ...
    return queryInfo === null || queryInfo === void 0 ? void 0 : (_queryInfo$exposure = queryInfo.exposure) === null || _queryInfo$exposure === void 0 ? void 0 : _queryInfo$exposure.others.map(_ref2 => {
      let {
        who
      } = _ref2;
      return who.toString();
