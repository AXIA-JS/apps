...
function extractSlashes(stashId) {
  let allSlashes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  return allSlashes.map(_ref => {
    let [era, all] = _ref;
    return {
      era,
      slashes: all.filter(_ref2 => {
        let {
          others,
          validator
        } = _ref2;
        return validator.eq(stashId) || others.some(_ref3 => {
          let [nominatorId] = _ref3;
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("td", {
      ...
      children: slashes.length !== 0 && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.Badge, {
        ...
        hover: t('Slashed in era {{eras}}', {
          replace: {
            eras: slashes.map(_ref6 => {
              let {
                era
              } = _ref6;
              return (0, _util.formatNumber)(era);
            }).join(', ')
          }
        }),
