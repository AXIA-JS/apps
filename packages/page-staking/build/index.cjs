...
function StakingApp({
  ...
  const [isInElection, paraValidators] = (0, _reactHooks.useCallMulti)([api.query.staking.eraElectionStatus, api.query.session.validators, (_ref = api.query.parasShared || api.query.shared) === null || _ref === void 0 ? void 0 : _ref.activeValidatorIndices], optionsParaValidators);
  ...
  const ownValidators = (0, _react.useMemo)(() => (ownStashes || []).filter(({
    isStashValidating
