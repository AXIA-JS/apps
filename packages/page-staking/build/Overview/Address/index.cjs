...
function expandInfo(_ref) {
  ...
  if (exposure && exposure.total) {
    ...
    nominators = exposure.others.map(_ref2 => {
      let {
        value,
        who
      } = _ref2;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("tr", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("td", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Favorite.default, {
        ...
        isMain: isMain,
        isPara: isPara,
        isRelay: !!((_ref4 = api.query.parasShared || api.query.shared) !== null && _ref4 !== void 0 && _ref4.activeValidatorIndices),
