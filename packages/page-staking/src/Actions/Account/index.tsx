...
import type { DeriveBalancesAll, DeriveStakingAccount } from '@axia-js/api-derive/types';
import type { StakerState } from '@axia-js/react-hooks/types';
import type { Option } from '@axia-js/types';
import type { SlashingSpans, UnappliedSlash } from '@axia-js/types/interfaces';
