...
function Balances(_ref) {
  ...
  const assetOptions = (0, _react.useMemo)(() => completeInfos.map((_ref2, index) => {
    let {
      id,
      metadata
    } = _ref2;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactComponents.Table, {
      ...
      children: info && (balances === null || balances === void 0 ? void 0 : balances.map(_ref3 => {
        let {
          accountId,
          balance
        } = _ref3;
        return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Account.default, {
          accountId: accountId,
          assetId: info.id,
          balance: balance,
