...
function Index(_ref) {
  ...
  const existingCloseBountyProposal = (0, _react.useMemo)(() => proposals === null || proposals === void 0 ? void 0 : proposals.find(_ref2 => {
    let {
      proposal
    } = _ref2;
    return proposal.method === 'closeBounty';
  }), [proposals]);
  const existingUnassignCuratorProposal = (0, _react.useMemo)(() => proposals === null || proposals === void 0 ? void 0 : proposals.find(_ref3 => {
    let {
      proposal
    } = _ref3;
    return proposal.method === 'unassignCurator';
  }), [proposals]);
