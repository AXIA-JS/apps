...
import { BN_ZERO, isBn } from '@axia-js/util';
const warnList = [];
export default function getInitValue(registry, def) {
  ...
  const type = [TypeDefInfo.Compact, TypeDefInfo.Option].includes(def.info) ? def.sub.type : def.type;
