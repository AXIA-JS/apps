...
function Vector({
  ...
  const _rowRemove = useCallback(() => setCount(count => count - 1), []);

  return /*#__PURE__*/_jsxs(Base, {
    className: className,
    isOuter: true,
    label: label,
    withLabel: withLabel,
    children: [!isDisabled && /*#__PURE__*/_jsxs("div", {
...
export default /*#__PURE__*/React.memo(Vector);