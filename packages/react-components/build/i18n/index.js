...
import { LANGUAGE_DEFAULT, settings } from '@axia-js/ui-settings';
...
settings.on('change', settings => {
  i18next.changeLanguage(settings.i18nLang === LANGUAGE_DEFAULT // eslint-disable-next-line @typescript-eslint/no-unsafe-call,@typescript-eslint/no-unsafe-member-access
  ? i18next.services.languageDetector.detect() : settings.i18nLang).catch(console.error);
});
