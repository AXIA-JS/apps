...
exports.isSelectAll = exports.isPaste = exports.isCut = exports.isCopy = exports.default = exports.KEYS_PRE = exports.KEYS = void 0;
...
function Input(_ref) {
  ...
  const _onChange = (0, _react.useCallback)(_ref2 => {
    ...
    return onChange && onChange(target.value);
  }, [onChange]);
