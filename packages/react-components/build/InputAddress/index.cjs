...
class InputAddress extends _react.default.PureComponent {
  ...
  hasValue(test) {
    return this.getFiltered().some(_ref4 => {
      let {
        value
      } = _ref4;
      return test === value;
  ...
  getFiltered() {
    ...
    return !optionsAll ? [] : optionsAll[type].filter(_ref5 => {
      let {
        value
      } = _ref5;
...
const ExportedComponent = (0, _hoc.withMulti)((0, _styledComponents.default)(InputAddress).withConfig({
  ...
  propName: 'optionsAll',
  transform: optionsAll => Object.entries(optionsAll).reduce((result, _ref6) => {
    let [type, options] = _ref6;
