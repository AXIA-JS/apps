...
var _components = _interopRequireDefault(require("./components.cjs"));

var _form = _interopRequireDefault(require("./form.cjs"));

var _media = _interopRequireDefault(require("./media.cjs"));

var _rx = _interopRequireDefault(require("./rx.cjs"));

var _semantic = _interopRequireDefault(require("./semantic.cjs"));

var _theme = _interopRequireDefault(require("./theme.cjs"));
...
function getHighlight(uiHighlight) {
  return uiHighlight || defaultHighlight;
}

function countBrightness(uiHighlight) {
...
var _default = (0, _styledComponents.createGlobalStyle)(_ref => {
  let {
    theme,
    uiHighlight
  } = _ref;
  ...
  /* Add our overrides */
  ${(0, _semantic.default)(theme)}
  ${_theme.default}
  ${_form.default}
  ${_media.default}
  ${_rx.default}
  ${(0, _components.default)(theme)}
`;
});
