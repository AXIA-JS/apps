...
function checkVisibility(api, address, accountInfo) {
  let filterName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
  let onlyNamed = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  let isVisible = false;
