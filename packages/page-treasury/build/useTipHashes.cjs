...
function useTipHashes() {
  var _api$events$tips, _api$events$tips2, _api$events$tips3, _ref2;
  ...
  return (0, _reactHooks.useMapKeys)((_ref2 = api.query.tips || api.query.treasury) === null || _ref2 === void 0 ? void 0 : _ref2.tips, {
