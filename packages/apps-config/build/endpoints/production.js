...
export function createProduction(t, firstOnly, withSort) {
  return expandEndpoints(t, [{
    ...
    providers: {
      // ChainX: 'wss://mainnet.chainx.org/ws', // https://github.com/axia-js/apps/issues/5547
    ...
    info: 'dock-mainnet',
    text: t('rpc.prod.dock-mainnet', 'Dock', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    providers: {
      ...
      'Patract Elara': 'wss://pub.elara.patract.io/nodle' // Pinknode: 'wss://rpc.pinknode.io/nodle/explorer' // https://github.com/axia-js/apps/issues/5721
