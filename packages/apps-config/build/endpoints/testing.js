...
export function createTesting(t, firstOnly, withSort) {
  return expandEndpoints(t, [// alphabetical based on chain name, e.g. Amber, Arcadia, Beresheet, ...
  {
    ...
    info: 'dock-testnet',
    isDisabled: true,
    // https://github.com/axia-js/apps/issues/5869
    text: t('rpc.test.dock-testnet', 'Dock', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'substrate',
    isDisabled: true,
    // https://github.com/axia-js/apps/issues/5571
    text: t('rpc.test.flamingfir', 'Flaming Fir', {
      ns: 'apps-config'
    }),
    providers: {
      AXIA: 'wss://substrate-rpc.axia.io'
    }
  }, {
    info: 'fantour',
    ...
    info: 'mybank',
    isDisabled: true,
    // https://github.com/axia-js/apps/issues/5845
    ...
    text: t('rpc.test.origintrail', 'OriginTrail Allychain Testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.test.subspace', 'Spartan testnet', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'ternoa-chaos',
    text: t('rpc.test.ternoa-chaos', 'Ternoa Chaos', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'unitv',
    isDisabled: true,
    // https://github.com/axia-js/apps/issues/5684
    ...
    info: 'web3games',
    isDisabled: true,
    // https://github.com/axia-js/apps/runs/2755409009?check_suite_focus=true
    ...
    info: 'zeitgeist',
    text: t('rpc.test.zeitgeist', 'Zeitgeist Battery Park', {
      ns: 'apps-config'
    }),
    providers: {
