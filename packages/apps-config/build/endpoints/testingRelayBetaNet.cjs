...
exports.createBetaNet = createBetaNet;
...
function createBetaNet(t) {
  return {
    dnslink: 'betanet',
    genesisHash: _constants.BETANET_GENESIS,
    info: 'betanet',
    text: t('rpc.betanet', 'BetaNet', {
      ns: 'apps-config'
    }),
    providers: {
      Parity: 'wss://betanet-rpc.axia.io' // OnFinality: 'wss://betanet.api.onfinality.io/public-ws', // After reset, node misses host functions
    ...
    }, // add any additional parachains here, alphabetical
    {
      ...
      // BetaNet reset
      paraId: 2037,
      text: t('rpc.betanet.origintrail', 'OriginTrail Parachain', {
        ns: 'apps-config'
      }),
      providers: {
