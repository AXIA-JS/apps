...
import { ALPHANET_GENESIS } from '../api/constants';
...
export function createAlphaNet (t: TFunction): EndpointOption {
  return {
    dnslink: 'alphanet',
    ...
    providers: {
      ...
      'light client': 'light://substrate-connect/alphanet'
      // 'NodeFactory(Vedran)': 'wss://alphanet.vedran.nodefactory.io/ws', // https://github.com/axia-js/apps/issues/5580
    },
    teleport: [1000],
    linked: [
