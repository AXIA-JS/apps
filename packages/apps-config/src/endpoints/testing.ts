...
export function createTesting (t: TFunction, firstOnly: boolean, withSort: boolean): LinkOption[] {
  return expandEndpoints(t, [
    ...
    {
      info: 'dock-testnet',
      isDisabled: true, // https://github.com/axia-js/apps/issues/5869
    ...
    {
      info: 'substrate',
      isDisabled: true, // https://github.com/axia-js/apps/issues/5571
    ...
    {
      info: 'mybank',
      isDisabled: true, // https://github.com/axia-js/apps/issues/5845
    ...
    {
      info: 'phoenix',
      isDisabled: true, // https://github.com/axia-js/apps/issues/6181
    ...
    {
      info: 'unitv',
      isDisabled: true, // https://github.com/axia-js/apps/issues/5684
    ...
    {
      info: 'web3games',
      isDisabled: true, // https://github.com/axia-js/apps/runs/2755409009?check_suite_focus=true
