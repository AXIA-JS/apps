...
// import AllychainInfo from '../Overview/AllychainInfo';
const optMulti = {
  defaultValue: {
    headHex: null,
    lifecycle: null,
  ...
  transform: _ref => {
    let [optHead, optGenesis, optLifecycle, optInfo] = _ref;
    return {
...
function Upcoming(_ref2) {
  ...
  const periods = (0, _react.useMemo)(() => (leasePeriod === null || leasePeriod === void 0 ? void 0 : leasePeriod.currentPeriod) && leases && leases.map(_ref3 => {
    let {
      period
    } = _ref3;
    return period;
  }), [leasePeriod === null || leasePeriod === void 0 ? void 0 : leasePeriod.currentPeriod, leases]);
