...
function Periods(_ref) {
  ...
  const mapped = (0, _react.useMemo)(() => (leasePeriod === null || leasePeriod === void 0 ? void 0 : leasePeriod.currentPeriod) && periods && periods.reduce((all, period) => {
    ...
    let [a, b] = _ref2;
    return a.eq(b) ? (0, _util.formatNumber)(a) : `${(0, _util.formatNumber)(a)} - ${(0, _util.formatNumber)(b)}`;
  }).join(', '), [leasePeriod === null || leasePeriod === void 0 ? void 0 : leasePeriod.currentPeriod, periods]);
