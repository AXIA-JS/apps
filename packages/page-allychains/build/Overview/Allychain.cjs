...
var _AllychainInfo = _interopRequireDefault(require("./AllychainInfo.cjs"));
...
const optionsMulti = {
  ...
  transform: _ref => {
    let [headData, optUp, optLifecycle, dmp, ump, hrmpE, hrmpI, optWm, optPending, optInfo, leases] = _ref;
    return {
...
function Allychain(_ref2) {
  var _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _paraInfo$lifecycle;
  ...
  const paraInfo = (0, _reactHooks.useCallMulti)([[api.query.paras.heads, id], [api.query.paras.futureCodeUpgrades, id], [api.query.paras.paraLifecycles, id], [(_ref3 = api.query.parasDmp || api.query.paraDmp || api.query.dmp) === null || _ref3 === void 0 ? void 0 : _ref3.downwardMessageQueues, id], [(_ref4 = api.query.parasUmp || api.query.ump) === null || _ref4 === void 0 ? void 0 : _ref4.relayDispatchQueues, id], [(_ref5 = api.query.parasHrmp || api.query.paraHrmp || api.query.hrmp) === null || _ref5 === void 0 ? void 0 : _ref5.hrmpEgressChannelsIndex, id], [(_ref6 = api.query.parasHrmp || api.query.paraHrmp || api.query.hrmp) === null || _ref6 === void 0 ? void 0 : _ref6.hrmpIngressChannelsIndex, id], [(_ref7 = api.query.parasHrmp || api.query.paraHrmp || api.query.hrmp) === null || _ref7 === void 0 ? void 0 : _ref7.hrmpWatermarks, id], [(_ref8 = api.query.parasInclusion || api.query.paraInclusion || api.query.inclusion) === null || _ref8 === void 0 ? void 0 : _ref8.pendingAvailability, id], [api.query.registrar.paras, id], [api.query.slots.leases, id]], optionsMulti);
  const [nonBacked, setNonBacked] = (0, _react.useState)([]);
  const channelCounts = (0, _react.useMemo)(() => [channelDst ? channelDst.reduce((count, _ref9) => {
    let [, channel] = _ref9;
    return count.iadd(channel.msgCount);
  }, new _bn.default(0)) : _util.BN_ZERO, channelSrc ? channelSrc.reduce((count, _ref10) => {
    let [, channel] = _ref10;
    return count.iadd(channel.msgCount);
  }, new _bn.default(0)) : _util.BN_ZERO], [channelDst, channelSrc]);
  ...
  const valRender = (0, _react.useCallback)(() => renderAddresses(validators && validators[1].map(_ref11 => {
    let {
      validatorId
    } = _ref11;
    return validatorId;
  }), validators && validators[1].map(_ref12 => {
    let {
      indexValidator
    } = _ref12;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("tr", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("td", {
      ...
      className: "start",
      children: paraInfo.updateAt && bestNumber && (_paraInfo$lifecycle = paraInfo.lifecycle) !== null && _paraInfo$lifecycle !== void 0 && _paraInfo$lifecycle.isAllychain ? /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      ...
      className: "number no-pad-left",
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_AllychainInfo.default, {
        id: id
      })
    }), /*#__PURE__*/(0, _jsxRuntime.jsxs)("td", {
...
var _default = /*#__PURE__*/_react.default.memo(Allychain);
