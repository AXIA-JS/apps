...
import Allychain from "./Allychain.js";
...
function Allychains({
  ...
  const headerRef = useRef([[t('allychains'), 'start', 2], ['', 'media--1400'], [t('head'), 'start media--1500'], [t('lifecycle'), 'start'], [], [t('included'), undefined, 2], [t('backed'), 'no-pad-left media--800'], [t('timeout'), 'no-pad-left media--900'], [t('chain'), 'no-pad-left'], [t('in/out (msg)'), 'media--1200', 2], [t('leases'), 'media--1000']]);
  ...
  return /*#__PURE__*/_jsx(Table, {
    ...
    children: knownIds === null || knownIds === void 0 ? void 0 : knownIds.map(([id, key]) => /*#__PURE__*/_jsx(Allychain, {
...
export default /*#__PURE__*/React.memo(Allychains);