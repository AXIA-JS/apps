...
import Allychain from './Allychain';
...
function Allychains ({ actionsQueue, ids, leasePeriod, scheduled }: Props): React.ReactElement<Props> {
  ...
  return (
    <Table
      empty={knownIds && t<string>('There are no registered allychains')}
...
export default React.memo(Allychains);
