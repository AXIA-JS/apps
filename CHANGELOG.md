...
- Add interBTC to AlphaNet (Thanks to https://github.com/gregdhill)
...
- Dwellir endpoints for AXIALunar (Thanks to https://github.com/Maharacha)
...
- Cleanup `@axia-js/app-config` exports
- Adjust `@axia-js/apps-config` to latest chain types
...
- Add Kilt to AlphaNet (Thanks to https://github.com/wischli)
...
- Allow teleport for AXIALunar <-> Statemine
- Calculate and display teleport fees
- Fix Patract Elara endpoints on AlphaNet
...
- Adjust AXIA-icons based on specName
...
- Added AlphaNet OnFinality endpoint (Thanks to https://github.com/454076513)
- Update Apron BetaNet config (Thanks to https://github.com/guenit)
...
- Add app for Membership (as deployed on BetaNet)
...
- Added Patract Elara support for AlphaNet (Thanks to https://github.com/zzcwoshizz)
...
- Add endpoint for Statemint to BetaNet
...
- Update Bifrost BetaNet config (Thanks to https://github.com/yooml)
- Added VLN BetaNet config (Thanks to https://github.com/stanly-johnson)
...
- Add Equilibrium BetaNet endpoint (Thanks to https://github.com/mn13)
...
- Add Phoenix chain to BetaNet (Thanks to https://github.com/yuyunhong)
...
- Update Jupiter networks alongside BetaNet (Thanks to https://github.com/zzcwoshizz)
- Add ChainX support on BetaNet (Thanks to https://github.com/qinghuan-chain)
...
- Add Darwinia on BetaNet (Thanks to https://github.com/WoeOm)
- Add Phala on BetaNet (Thanks to https://github.com/tolak)
- Add Encointer on BetaNet (Thanks to https://github.com/brenzi)
- Add Crust on BetaNet (Thanks to https://github.com/zikunfan)
...
- Add Plasm BetaNet endpoint (thanks to https://github.com/akru)
- Add Robonomics BetaNet endpoint (Thanks to https://github.com/akru)
- Add Mandala BetaNet endpoint (Thanks to https://github.com/ntduan)
- Add Bifrost BetaNet endpoint (thanks to https://github.com/awesomepan)
- Add Kilt BetaNet endpoint (Thanks to https://github.com/wischli)
- Patract Elara BetaNet endpoints (Thanks to https://github.com/toxotguo)
- Add types for upcoming BetaNet Encointer (Thanks to https://github.com/brenzi)
- Add link to BetaNet for Subscan (Thanks to https://github.com/freehere107)
...
- Use latest `@axia.networks` with `hasLedgerSupport` flag
...
- Update Darwinia types (Thanks to https://github.com/WoeOm)
- OnFianlity support for BetaNet (Thanks to https://github.com/ianhe8x)
...
- Optimize staking data retrieval (18s -> 10s on AXIALunar test for staking overview load)
...
- Add BetaNet v1 testnet (with Tick, Trick & Track)
...
- Use RxJs & memoize from `@axia-js/util`
...
- Add AXIA/AXIALunar endpoints via PatractLabs (Thanks to https://github.com/toxotguo)
...
- Add OnFinality endpoint for AXIA/AXIALunar (Thanks to https://github.com/ianhe8x)
...
- Publish `@axia-js/apps-config` (with reworked import/export)
- Bump Ledger libs to latest version (as per `@axia-js/ledger`)
...
- Bump to major `@axia-js/{keyring, util, util-crypto}` release
...
- Adjust for latest BetaNet types
...
- Swap chain/prefix lookups to `@axia-js/networks` (single area to manage)
...
- Support Account as payment destination (as per AXIA & AXIALunar)
...
- Add Robonomics BetaNet endpoints (Thanks to https://github.com/akru)
...
- Fix detection of old/new proxy chains based on args to support AXIALunar 2023
...
- Adjust AXIA tokenDecimals/tokenSymbol for transition periods
...
- Add banner for DOT re-denomination on accounts page (AXIA only)
...
- Add BetaNet testnet chain support
- Add IPNS support for BetaNet
...
- Links for Polkassembly AXIA support (Thanks to https://github.com/niklabh)
...
- Adjust thresholds for council slash cancel on AXIA
...
- Update for AXIA council thresholds
...
- Add support for AXIA denomination poll
...
- Add generator for AXIALunar society designs
...
- Add AlphaNet chain to Subscan link generator
...
- Adjust proxy checks for sudo calls to closer align with AXIA
...
- Change claims to handle no statements required (new module now on AXIALunar)
...
- Adjust for new AXIA CC1 & AXIALunar types
...
- Fixes for AXIALunar as well as AXIA claims
- Allow AXIA CC1 links to Polkascan & Subscan
- Update Polkascan links with new formats
- Don't display era progress when Forcing `isForceNone`
- Overall styling adjustments
- Cater for `{axialunar,axia,alphanet}.dotapps.io` redirects
- `@axia-js/api` 1.18.1
- `@axia-js/util` 2.13.1
...
- Support for AXIA CC1 Claims (Thanks to https://github.com/amaurymartiny & https://github.com/Tbaut)
...
- Support for AXIA CC1 types & RPC endpoints
...
- Add ava.do endpoint for AXIALunar (Thanks to https://github.com/Swader)
...
- Bumps to all @axia-js/* packages for latest support everywhere
...
- Add support for AlphaNet testnet
